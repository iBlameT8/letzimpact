      ...
      <div className="container">
        <div className="grid gap-10 lg:grid-cols-12 lg:items-end">
          <div className="lg:col-span-7">
            <SectionLabel num="04" label={copy.founders.label} />
            <h2 className="mt-5 font-display text-[34px] font-bold leading-[1.05] tracking-tight sm:text-5xl lg:text-6xl">
              ...
              <span className="text-gradient">{copy.founders.highlight}</span>.
            </h2>
          </div>
        ...
        <div className="mt-12 grid items-stretch gap-5 sm:mt-16 sm:gap-6 md:grid-cols-2">
          <FounderCard
            img={ANAS}
            name="Anas Ourabi"
            role={copy.founders.founderRole}
            offset
          />
          <FounderCard
            img={DZENAN}
            name="Dzenan Skoko"
            role={copy.founders.coFounderRole}
          />
        </div>
  ...
  return (
    ...
    >
      <div className="relative aspect-[4/5] w-full overflow-hidden">
        ...
        />
        {/* corner meta */}
        <div className="absolute left-5 top-5 flex items-center gap-2 rounded-full bg-black/40 px-3 py-1.5 font-mono-acc text-[11px] uppercase tracking-[0.18em] text-white/85 ring-1 ring-white/15 backdrop-blur">
