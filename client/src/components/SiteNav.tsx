...
function LanguageSwitcher({ className = "" }: { className?: string }) {
  ...
  return (
    <div
      ...
      className={`inline-flex items-center rounded-full bg-white/[0.04] p-1 ring-1 ring-white/10 ${className}`}
    >
      {LANGUAGES.map(item => {
        ...
        return (
          <button
            ...
            aria-pressed={active}
            className={`rounded-full px-2.5 py-1.5 font-mono-acc text-[10px] font-semibold tracking-[0.14em] transition sm:px-3 ${
              active
                ? "bg-white text-[#07060B]"
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              className="relative hidden h-9 w-9 place-items-center overflow-hidden rounded-full sm:grid md:hidden"
              style={{
                background:
        ...
        {open && (
          ...
          >
            ...
            >
              ...
              <div className="mt-8 flex flex-col gap-1 sm:mt-10 sm:gap-2">
                {NAV_LINKS.map((l, i) => (
                  <motion.button
                    key={l.id}
